...
public class HardwareTestBed_5159_v01 {

    // intializing all motors
    ...
    /* Constructor */
    public HardwareTestBed_5159_v01() {
    ...
    //reset encoders after running to position (autonomous)
    ...
    // creating a go forward function
    boolean goForward (int nAddlEncoderCount, double dPwr,LinearOpMode linopmode,double dTimeOutMS) {
        ...
        //if motors do not get to position in time, timeout
